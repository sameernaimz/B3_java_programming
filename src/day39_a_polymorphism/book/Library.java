...
public class Library {
  ...
  book1.size = 30.0; // mg
        ...
        book2.name = "JAVA OCA";
        book2.size = 30.0; // mg
      //  book2.isFun = true;  // E book does not have access
        ((JavaTextBook) book2).isFun = true;
  // AFTER DOWNCASTING I AM ABLE TO REACH to the class JavaTextBook which has access to isFun, I am able to reach it.
        //        book2.read();
