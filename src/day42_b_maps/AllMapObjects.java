...
public class AllMapObjects {
    public static void main(String[] args) {
        ...
        Map<String,String> map1 =new HashMap<>(); // not ordered
        ...
        map2.put("test", null); // null VALUE is OK - NullPointerException
        ...
        map3.put("test", null); // null VALUE is OK - NullPointerException
